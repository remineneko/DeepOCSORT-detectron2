...
from .async_tracker_predictor import AsyncTrackerPredictor


class TrackerDemo:
    """
    Similar to VisualizationDemo, with minor changes on what predictor classes are used.
    """
    def __init__(
            self, 
            cfg: CfgNode, 
        ...
        if parallel:
            ...
            self.predictor = AsyncTrackerPredictor(cfg, num_gpus=num_gpu)
        else:
            self.predictor = TrackerPredictor(cfg)
